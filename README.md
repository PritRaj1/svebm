# svebm
Unsupervised model from [Pang et al](https://openreview.net/forum?id=-pLftu7EpXz), with LightningCLI and torch dynamo. This repo does nothing, it's just for prototyping.
