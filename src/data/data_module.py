...
class TextDataModule(L.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        # Resolve collate_fn if parsed string
        if isinstance(self.collate_fn, str):
            self.collate_fn = _resolve_class_path(self.collate_fn)
    ...
    def train_dataloader(self) -> DataLoader:
        ...
        if isinstance(collate_fn, str):
            collate_fn = _resolve_class_path(collate_fn)
        elif collate_fn is None:
            from src.data.ptb_data import ptb_collate_fn

            collate_fn = ptb_collate_fn
